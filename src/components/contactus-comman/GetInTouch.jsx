...
function GetInTouch() {
  ...
  return (
    <>
      <Components className="flex flex-1 sm:flex-col md:flex-col">
        <div className="flex flex-col w-2/4 sm:w-full md:w-full lg:pr-10 xl:pr-10">
          <span className="text-xl font-bold text-gray-500 text-left pb-2">
            Let’s get in touch
          </span>
          <p className="text-left text-gray-400 text-justify">
            ...
            cursus a sit amet mauris. Nec sagittis sem nibh id elit. Aenean
            sollicitudin, lorem quis bibendum auctor. Nisi elit consequat ipsum,
            nec sagittis sem nibh id elit. Duis sed odio sit amet nibh
            vulputate, nec sagittis sem nibh id elit. Duis sed odio sit amet
            nibh vulputate cursus a sit amet mauris.
          </p>
          <div className=" flex flex-col mt-8">
            <span className="text-2xl font-bold text-gray-500 text-left">
              Send us an Email
            </span>
            <form>
        ...
        <div className="flex flex-col w-2/4 sm:w-full md:w-full sm:mt-6 md:mt-6 lg:pl-10 xl:pl-10">
          <div>
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3784.8393344278593!2d73.80138207279747!3d18.44560258263346!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bc2953abbedeb37%3A0x6f25bdffe8f2da4e!2sSun%20Crest!5e0!3m2!1sen!2sin!4v1691825317525!5m2!1sen!2sin"
              className="w-full sm:h-96 md:h-96 pb-8"
              height="450"
              allowfullscreen=""
              loading="lazy"
          ...
          <div className="flex flex-col bg-yellow-00 py-4 border-y border-gray-400 text-gray-500">
            <span className="text-left text-2xl font-bold text-gray-500">
              Contact Info
            </span>
            <span className="text-left py-2">
              Address: 738 Kertzmann Wall, 4989 Louie Rapid
            </span>
            <span className="text-left py-2">Email: info@domain.com</span>
            <span className="text-left py-2">
              Phone: (213) 2020 555013, (213) 7700 900106
            </span>
